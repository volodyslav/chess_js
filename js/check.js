...
function kingMovementCheck(topKingPos, leftKingPos, imgKing, kingColorCheck){
...
function checkColorCheck(){
    ...
    kingMovementCheck(topKingPos, leftKingPos, imgKing, kingColorCheck)

    // Check king's y posible positions
    for (let i = -1; i <= 1; i+=2){
        const top = topKingPos + i;
        if (top >= 0 && top < 8){
            kingMovementCheck(top, leftKingPos, imgKing, kingColorCheck)
        }
    }
    ...
    for (let i = -1; i <= 1; i+=2){
        ...
        if (left >= 0 && left < 8){
            kingMovementCheck(topKingPos, left, imgKing, kingColorCheck)
        }
    }
    ...
    for (let i = -1; i <= 1; i+=2){
        for (let j = -1; j <= 1; j+=2){
            ...
            if (left >= 0 && left < 8 && top >= 0 && top < 8){
                kingMovementCheck(top, left, imgKing, kingColorCheck)
            }
        }
    }
